...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand active" href="#">mohammed abbas</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
      <li class=""><a href="categores.php">Cateogries <span class="sr-only">(current)</span></a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="profile/index.php">الذهاب لصفحة البروفايل</a></li>
            <li><a href="end.php">log out</a></li>
